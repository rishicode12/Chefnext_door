    ...
    <div className="bg-card border border-border rounded-lg p-4 sticky top-20">
      ...
      <div className="mt-6 pt-4 border-t border-border">
        ...
        <p className="text-xs text-muted-foreground mb-3">
          Our chef support team is available 24/7 to assist you with your food orders.
        </p>
        <div className="space-y-2">
          <a
            href="tel:+91-800-COOKS"
          ...
          <a
            href="mailto:chefs@yummyfoods.com"
            className="flex items-center space-x-2 text-xs text-primary hover:underline"
          >
            <Icon name="Mail" size={12} />
            <span>chefs@yummyfoods.com</span>
          </a>
        </div>
      </div>
    </div>
