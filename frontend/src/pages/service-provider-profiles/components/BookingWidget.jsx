    ...
    <div className={`bg-card border border-border rounded-lg ${isSticky ? 'sticky top-24' : ''}`}>
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="font-semibold text-foreground">Book Food</h3>
        ...
        <div className="mt-6 pt-6 border-t border-border">
          <div className="flex items-center justify-center space-x-4 text-sm text-muted-foreground">
            ...
            {/* Verification indicator removed as requested */}
            <div className="flex items-center space-x-1">
        ...
        <div className="mt-4 p-3 bg-destructive/10 border border-destructive/20 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <div className="text-sm">
              <span className="font-medium text-foreground">Need urgent food service?</span>
              <p className="text-muted-foreground">Call {provider.phone} for immediate meal preparation</p>
            </div>
          </div>
        </div>
      </div>
