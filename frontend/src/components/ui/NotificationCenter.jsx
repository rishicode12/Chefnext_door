  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message: 'Your chef booking is scheduled for tomorrow at 2 PM',
      time: '2 hours ago',
      read: false,
      icon: 'Calendar',
      color: 'text-success',
    },
    {
      ...
      message: 'Please rate your experience with Chef Hari\'s Kitchen',
      time: '1 day ago',
      read: false,
      icon: 'CheckCircle',
      color: 'text-primary',
    },
    {
      ...
      message: 'Your meal delivery will arrive in 30 minutes',
      time: '30 minutes ago',
      read: true,
      icon: 'Clock',
      color: 'text-warning',
    },
    {
      ...
      type: 'promotion',
      title: 'Special Offer',
      message: '20% off your next meal order',
      time: '2 days ago',
      read: true,
      icon: 'Gift',
      color: 'text-accent',
